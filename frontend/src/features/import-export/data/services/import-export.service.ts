...
export const parseExcelFile = (file: File): Promise<Array<Record<string, unknown>>> => {
...
export const exportToExcel = (data: Array<Record<string, unknown>>, filename: string): void => {
